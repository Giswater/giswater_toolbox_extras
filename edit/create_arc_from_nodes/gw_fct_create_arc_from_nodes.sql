...
DROP FUNCTION IF EXISTS SCHEMA_NAME.gw_fct_create_arc_from_nodes(json);
CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_create_arc_from_nodes(p_data json)
  RETURNS json AS
$BODY$

/*EXAMPLE
SELECT SCHEMA_NAME.gw_fct_set_create_arc_from_nodes($${
